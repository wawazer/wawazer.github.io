        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-30 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/distrive.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                ...
                <Img src={"/distrive.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">Distrive Assets </span>
                <a href="https://distrive.id" target="_blank" rel="noopener noreferrer">
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  At <span className="text-AAsecondary">Distrive</span>, I played in developing assets
                  components for their <span className="text-AAsecondary">web and mobile applications</span>. Our focus was on integrating new features and improving the user interface. 
                  
                </p>
              </div>
              <div className="z-10 flex fle-row space-x-5 ">
                <a href="https://distrive.id/" target={"_blank"} rel="noreferrer">
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/ptosm.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/ptosm.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                <span className="text-AAsecondary text-base">Application Harbour</span>
                <a href="https://ptosm.pelindo.co.id" target="_blank" rel="noopener noreferrer">
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    PTOS-M
                  </span>
                </a>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/pfiles.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/pfliles.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            <div className="absolute w-full   rounded  ml-4 mt-2  text-end pr-8">
              <div className="w-full"></div>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                This <span className="text-AAsecondary">application</span>is for storing document data for company needs. 
                  {/* It&apos; a barber shop <span className="text-AAsecondary">appointment scheduling</span> & management
                  software it provides <span className="text-AAsecondary">online scheduling</span>, appointment
                  reminders, <span className="text-AAsecondary">payments</span>, marketing, and much more! Currently in
                  the <span className="text-AAsecondary">Initiation phase</span>. */}
