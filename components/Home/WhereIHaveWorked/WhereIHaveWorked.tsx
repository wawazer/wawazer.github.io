...
import RsBedah from "./Descriptions/RsBedah";
...
const CompaniesBar = (props) => {
  const [barPosition, setBarPosition] = React.useState<Number>(-5); // Green bar position by the default it's -20px
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}  {/*  //   ?ngatur tinggi bar//   */}
      <div
